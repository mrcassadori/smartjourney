...
const NAV_ITEMS = [
  ...
  { key: 'simulador', label: 'Simulador', icon: 'target', route: 'simulacoes', permKey: 'recommendations' },
  { key: 'planejamento', label: 'Planejamento', icon: 'flag', route: 'planejamento', permKey: 'planning' },
