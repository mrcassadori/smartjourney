...
> Backlog de épicos e histórias de usuário, derivado de `especificacao_projeto_customer_journey.docx` (spec original) e confrontado com o estado real de `app.jsx` / `prototype.html` / `DATA_MODEL.md`. Serve como ponto único de verdade antes de evoluir o produto: o que já existe, o que é parcial e o que ainda não foi construído.
