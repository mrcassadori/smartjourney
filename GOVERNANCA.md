...
- **Pendente (prioridade média/baixa)**: título/subtítulo próprio nas abas Risco e Liquidez/Análise técnica/Comparação do dashboard; gauge de risco (régua) no lugar de `RiskDots`; barras de volatilidade comparativa na Análise técnica; rótulos completos nas seções do relatório (Tela 13); avatar nos cards de cliente do Simulador; filtros granulares (CNPJ/subclasse/vencimento) na busca de produtos — não implementados nesta fase.
